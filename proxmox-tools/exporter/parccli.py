#!/usr/bin/env python3
"""
Script to parse ParcCLI's JSON output and expose
...
ParcCli port by https://github.com/MCWertGaming
"""
...
if __name__ == "__main__":
    ...
    PARSER.add_argument(
        '--storcli_path', default='/opt/MegaRAID/perccli/perccli64', help='path to StorCLi binary')
